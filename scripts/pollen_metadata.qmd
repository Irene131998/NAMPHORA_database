...
The ***NAMPHORA*** (*Northern Africa, Arabian, and Mediterranean Pollen Holocene Records Archive*) is an open-access database that compiles fossil and modern pollen records from Northern Africa, Arabia, and the Mediterranean. The database includes fossil and modern pollen records, both raw and harmonised, as well as un-calibrated and recalibrated radiocarbon dates.

Details on the geographical, temporal and other relevant information of all the pollen records has been compiled in the “*database.csv*” file, which contains the following metadata:
...
site_metadata <- data.frame(
  Name = c("Biogeographic area", "Country", "Site", "Site_name_machine_readable", 
                   "Archive type", "Latitude", "Longitude", "Altitude", "Database", "Record type", 
  ...
  Description = c("Biogeographical region to which the site belongs", 
                  ...
                  "Database from which the site was retrieved", 
                  "Specifies whether the pollen record is modern or fossil. Modern if the pollen grains were obtained from a modern sediment or fossil if pollen grains are preserved in older sediments", 
                  ...
                  "Geological time period of the site, including Late Holocene (Meghalayan: 0 to 4.2 ka BP), Mid Holocene (Northgrippian: 4.2 to 8.2 ka BP), Early Holocene (Greenlandian: 8.2 to 11.7 ka BP), Pre-Holocene (11.7 to 240 ka BP), Holocene (0 to 11.7 ka BP), and Holocene-Pre-Holocene (present to 240 ka BP)", 
                  "Indicates whether the site coincides fully or partially with the African Humid Period (14.8 to 5.5 ka BP)", 
                  "Minimum mean age (Before Present) of the site", 
                  "Maximum mean age (Before Present) of the site", 
