...
#| echo: false
#| output: true
#| fig-cap: "Figure 2. Map of fossil and modern pollen records (a) compiled in the *NAAMPHoRA* database, the phytogeographical regions from White (1983) and Olson et al. (2001) (b) the biome map (c) from Olson et al. (2001)."
