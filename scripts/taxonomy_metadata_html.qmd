...
1.  **Harmonisation of taxonomic names**
    ...
    -   Pollen types were also cross-referenced with published harmonisation tables:
        ...
        -   **Vincens *et al*. (2007)** \[3\]

    -   Synonyms and outdated classifications were updated to match current botanical taxonomy.

2.  **Incorporation of habit and phytogeographical affinity information**

    -   Taxa were assigned plant habit (growth form) categories following POWO & several references.

    -   Taxa were assigned phytogeographical affinities following GBIF, POWO & several references.

    -   Phytogeographical affinities were linked to GBIF & POWO.
...
3.  **Final harmonisation list**
    ...
    -   Metadata on the harmonisation process is provided here: in **taxonomy_metadata.csv** and **taxonomy_metadata.html.**
...
attributes <- data.frame(
  Name = c("Palaeo_Modern", "Original_taxa", "Family", "Genus", "Species_pollen_type", 
               ...
               "Observations_SM", "Fossil_Sequences_dated", "Fossil_Sequences_not_dated", 
  ...
  Description = c("Indicates whether the data is from fossil (Palaeo) or modern (Modern) records", 
                  ...
                  "Number of fossil sequences with chronology", 
                  "Number of fossil sequences without chronology", 
                  "Number of modern sequences", 
                  ...
                  "Link to POWO record", 
                  "Growth form or life habit of the plant", 
...
1.  Lézine, A. M., Watrin, J., Vincens, A. & Hély, C. Are modern pollen data representative of west African vegetation? Rev. Palaeobot. Palynol. 156, 265–276 (2009).

2.  Mott, O. et al. Global acceleration in rates of vegetation change over the past 18,000 years. Science 372, 860–864 (2021).

3.  Vincens, A., Lézine, A. M., Buchet, G., Lewden, D. & Le Thomas, A. African pollen database inventory of tree and shrub pollen types. Rev. Palaeobot. Palynol. 145, 135–141 (2007).
