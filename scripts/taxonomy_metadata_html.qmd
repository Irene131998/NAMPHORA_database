...
2.  **Incorporation of habit and phytogeographical affinity information**
    ...
    -   Habit and phytogeograhical affinities were also cross-referenced with the pollen inventory of **Vincens *et al.* (2007)** \[3\].
...
attributes <- data.frame(
  ...
  Description = c("Indicates whether the data is from fossil (Palaeo) or modern (Modern) records", 
                  ...
                  "Number of dated fossil records in which the original pollen type is present", 
                  "Number of undated fossil records in which the original pollen type is present", 
