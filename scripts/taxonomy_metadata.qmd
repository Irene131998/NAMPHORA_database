...
attributes <- data.frame(
  Name = c("Palaeo_Modern", "Original_taxa", "Family", "Genus", "Species_pollen_type", 
               ...
               "Phytogeographical_affinity_summarised", "Link_GBIF", "Link_POWO", 
  ...
  Description = c("Indicates whether the data is from fossil (Palaeo) or modern (Modern) records", 
                  ...
                  "Link to Global Biodiversity Information Facility (GBIF: https://www.gbif.org/)  record", 
                  "Link to Plants of the World Online (POWO: https://powo.science.kew.org/) record", 
  ...
  Unit = c("Categorical", "Categorical", "Categorical", "Categorical", "Categorical", "Categorical", "Categorical", 
           ...
           "count", 
           "count", "count", "Categorical","Categorical", 
           "Categorical", "Categorical", "Categorical", "Categorical", 
           "Categorical", "Categorical", "Categorical", "Categorical", 
           "Categorical", "Categorical", "Categorical", "Categorical", 
           "Categorical", "Categorical", "Categorical", "Categorical", 
