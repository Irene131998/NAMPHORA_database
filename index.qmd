...
-   `data/`: All raw and processed data are stored in this folder.
    ...
    -   `/raw_data`: contains raw data on the following subfolders:
        ...
        -   `/taxonomy`: contains two subfolders:

            -   `/harmonisation_lists`: contains harmonisation tables
                from Lézine *et al*. (2009) \[3\], Mottl *et al.* (2021)
                \[4\] & the APD
...
libraries <- c("dplyr","readxl","readr","here","tidyr","BIEN","purrr","sp","terra","geodata","tidyterra","ggtext","ggplot2","openxlsx","stringr","leaflet","sf","quarto")
